...
const Admin = () => {
    ...
    try {
      const formData = {
        ...
        releaseYear: movieForm.releaseYear
          ? parseInt(movieForm.releaseYear)
          : null,
  ...
  const handleShowSubmit = async (e) => {
    ...
    try {
      const formData = {
        ...showForm,
        type: 1,
        releaseYear: showForm.releaseYear
          ? parseInt(showForm.releaseYear)
          : null,
        seasonsCount: showForm.seasonsCount
          ? parseInt(showForm.seasonsCount)
          : null,
        episodesCount: showForm.episodesCount
          ? parseInt(showForm.episodesCount)
          : null,
  ...
  const editShow = (showItem) => {
    ...
    setShowsForm({
      ...
      seasonsCount: showItem.seasonsCount
        ? showItem.seasonsCount.toString()
        : "",
      episodesCount: showItem.episodesCount
        ? showItem.episodesCount.toString()
        : "",
              ...
              <form onSubmit={handleMovieSubmit} className="admin-form">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setMovieForm({ ...movieForm, imageUrl: e.target.value })
                    }
                    required
                  />
                </div>
              ...
              <form onSubmit={handleShowSubmit} className="admin-form">
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setShowsForm({ ...showForm, title: e.target.value })
                    }
                    required
                  />
                </div>
                ...
                <div className="form-group">
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setShowsForm({ ...showForm, description: e.target.value })
                    }
                    required
                    rows="4"
                  />
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setShowsForm({ ...showForm, imageUrl: e.target.value })
                    }
                    required
                  />
                </div>
                ...
                {shows.map((showItem) => (
                  <div key={showItem.id} className="item-card">
                    ...
                    <div className="item-info">
                      ...
                      <p>
                        {showItem.releaseYear} • {showItem.seasonsCount} seasons
                        • {showItem.episodesCount} episodes
                      </p>
                      <div className="item-genres">
                      ...
                      <div className="item-actions">
                        <button
                          onClick={() => editShow(showItem)}
                          className="btn-edit"
                        >
                          Edit
                        </button>
                        <button
                          onClick={() => handleDeleteShow(showItem.id)}
                          className="btn-delete"
                        >
                          Delete
                        </button>
