            ...
            <nav className="settings-nav">
              ...
              >
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M17.07 20C17.07 16.13 13.9 13 10 13C6.1 13 2.93 16.13 2.93 20" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                Account Info
              </button>
              <button
              ...
              >
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M15 8.33333V5C15 2.23858 12.7614 0 10 0C7.23858 0 5 2.23858 5 5V8.33333" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M4.16667 8.33333H15.8333C17.214 8.33333 18.3333 9.45262 18.3333 10.8333V16.6667C18.3333 18.0474 17.214 19.1667 15.8333 19.1667H4.16667C2.78595 19.1667 1.66667 18.0474 1.66667 16.6667V10.8333C1.66667 9.45262 2.78595 8.33333 4.16667 8.33333Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                Security
              </button>
              <button
                ...
                <div className="settings-section">
                  ...
                  <form onSubmit={handleUpdateProfile} className="settings-form">
                    ...
                    <div className="form-group">
                      ...
                      />
                      <small className="form-hint">Your account role cannot be changed</small>
                    </div>
                  ...
                  <div className="danger-card">
                    <div className="danger-info">
                      ...
                      <p>
                        ...
                        including your watchlist and ratings, will be permanently deleted.
                      </p>
                    </div>
                    <button
